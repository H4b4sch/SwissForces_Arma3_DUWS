  ...
  lbSetCurSel [2102, index_amount_zones_3];  
  ...
  index_amount_cp_60 = lbAdd [2103, "60 (can unlock more items)"];
  index_amount_cp_100 = lbAdd [2103, "100"];
  index_amount_cp_200 = lbAdd [2103, "200 (can unlock alot of items)"];
  index_amount_cp_300 = lbAdd [2103, "300 (good for sharing in MP)"];
  index_amount_cp_400 = lbAdd [2103, "400 (good for larger group sharing MP)"];
  index_amount_cp_600 = lbAdd [2103, "600 (max unlock points!)"];  
  ...
  index_blufor_ap_170 = lbAdd [2104, "170"];
  index_blufor_ap_200 = lbAdd [2104, "200"];
  lbSetCurSel [2104, index_blufor_ap_170];         
       
  // OPFOR AP         
  index_opfor_ap_0 = lbAdd [2105, "0 (easy start/less units/best fps)"]; 
  ...
  index_opfor_ap_170 = lbAdd [2105, "170"];
  index_opfor_ap_200 = lbAdd [2105, "200 (difficult start/more units/worst fps)"];
  ...
  lbSetCurSel [2106, index_weather_type_arid];        
...
*/
  ...
  index_op_skill_veteran = lbAdd [2107, "Veteran (0.35-0.45)"];
